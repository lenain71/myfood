...
namespace myfoodapp.Core.Business
{
    ...
    public sealed class HumidityTemperatureManager
    {
        ...
        /// Device I2C Address
        /// </summary>
        private const ushort Htu21dI2cAddress = 0x40;
        ...
        public void Connect()
        {
            ...
            var settings = new I2cConnectionSettings(1, Htu21dI2cAddress);


            this.i2c = I2cDevice.Create(settings);
            ...
            else
            {
                ...
                try
                {
                    this.i2c.WriteRead(new byte[] { SampleHumidityHold }, i2cTemperatureData);
        ...
        public float Temperature
        {
            get
            {
                ...
                ushort rawTemperatureData = this.RawTemperature;
                double temperatureCelsius = ((175 * rawTemperatureData) / 65536) - 46.85;
